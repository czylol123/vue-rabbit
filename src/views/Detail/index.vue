        ...
        <div class="container">
            <div class="bread-container">
                <el-breadcrumb separator=">">
                    ...
                    <!-- 
                        错误原因: goods——初始为{}, {}.categories -> undefined -> undefined[1]
                        解决方案:
                                1. 可选链的语法 ?.   goods.categories?.[1].name
                                2. v-if手动控制渲染时机，保证只有数据存在才渲染   v-if="goods.details"
                    -->
                        ...
                        <div class="media">
                            ...
                            <ul class="goods-sales">
                                ...
                                <li>
                                    ...
                                    <p><i class="iconfont icon-task-filling"></i>查看评价</p>
                                </li>
                                <li>
                                    <p>收藏人气</p>
                                    <p>{{ goods.collectCount }}</p>
                                    <p><i class="iconfont icon-task-filling"></i>收藏商品</p>
                                </li>
                                <li>
                                    <p>品牌信息</p>
                                    <p>{{ goods.brand?.name }}</p>
                                    <p><i class="iconfont icon-task-filling"></i>品牌主页</p>
                                </li>
                            </ul>
                        </div>
                        <div class="spec">
                            ...
                            <div>
                                <el-button size="large" class="btn" @click="addCarts" type="danger" plain>
                                    加入购物车
                                </el-button>
                            </div>
                        </div>
